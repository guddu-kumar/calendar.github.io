...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["client-core-documents-documents-module"], {
  ...
  /***/
  function srcAppPagesClientCoreDocumentsDocumentsCoreDocumentsCoreComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DocumentsCoreComponent", function () {
      return DocumentsCoreComponent;
    });
    /* harmony import */
    ...
    var DocumentsCoreComponent =
    /*#__PURE__*/
    function () {
      function DocumentsCoreComponent() {
        _classCallCheck(this, DocumentsCoreComponent);
      }

      _createClass(DocumentsCoreComponent, [{
        key: "ngOnInit",
    ...
    DocumentsCoreComponent.ɵfac = function DocumentsCoreComponent_Factory(t) {
      return new (t || DocumentsCoreComponent)();
    };

    DocumentsCoreComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DocumentsCoreComponent,
      selectors: [["app-documents-core"]],
      decls: 1,
      vars: 0,
      template: function DocumentsCoreComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DocumentsCoreComponent, [{
  ...
  /***/
  function srcAppPagesClientCoreDocumentsDocumentsCoreKycUploadKycUploadComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "KycUploadComponent", function () {
      return KycUploadComponent;
    });
    /* harmony import */
    ...
    var _shared_services_notification_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _c0 = ["video"];
    var _c1 = ["canvas"];
    var _c2 = ["autoShownModal"];

    function KycUploadComponent_div_1_label_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function KycUploadComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onHidden", function KycUploadComponent_div_1_Template_div_onHidden_0_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_div_1_Template_button_click_7_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r424);

          var ctx_r425 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r425.hideModal();
        });
    ...
    function KycUploadComponent_button_100_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_button_100_Template_button_click_0_listener() {
          ...
          var _r420 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](103);

          return ctx_r426.capture(_r420);
        });
    ...
    var KycUploadComponent =
    /*#__PURE__*/
    function () {
      function KycUploadComponent(notificationService, renderer, global, http, spinner) {
        _classCallCheck(this, KycUploadComponent);
      ...
      _createClass(KycUploadComponent, [{
        ...
        key: "open_camera",
        value: function open_camera(documentType) {
          this.startCamera();
        ...
        value: function capture(c) {
          ...
          this.http.post('http://client.traderscabinet.com/tr_test/assets/PHP/alfa/v1/common/UploadDipositPaymentReceipt', data).subscribe(function (res) {
            if (res) {
              _this2.spinner.hide();
            }

            if (_this2.iddocs == 'id') {
              _this2.kycParams.KYC_IDProof = res.resp.url;
              localStorage.setItem('idproof', res.resp.url);
            }

            if (_this2.adddocs == 'add') {
              _this2.kycParams.KYC_AddrProof = res.resp.url;
              localStorage.setItem('addproof', res.resp.url);
            }

            if (_this2.otherdocs == 'oth') {
              _this2.kycParams.KYC_Others = res.resp.url;
        ...
        value: function encodeImageFileAsURL(element, documentType, fileInput) {
          var _this3 = this;
          ...
          reader.onload = function () {
            ...
            _this3.http.post('http://client.traderscabinet.com/tr_test/assets/PHP/alfa/v1/common/UploadDipositPaymentReceipt', data).subscribe(function (res) {
              if (res) {
                _this3.spinner.hide();
              }

              if (documentType == 'id') {
                _this3.kycParams.KYC_IDProof = res.resp.url;
                localStorage.setItem('idproof', res.resp.url);
              }

              if (documentType == 'add') {
                _this3.kycParams.KYC_AddrProof = res.resp.url;
                localStorage.setItem('addproof', res.resp.url);
              }

              if (documentType == 'oth') {
                _this3.kycParams.KYC_Others = res.resp.url;
                localStorage.setItem('othproof', res.resp.url);
              }
            }, function (err) {
              _this3.spinner.hide();
        ...
        value: function updateKYC() {
          ...
          //   }, 10000);
          // } else {
          var id = localStorage.getItem('idproof');
          var add = localStorage.getItem('addproof');
          var oth = localStorage.getItem('othproof');
          ...
          this.spinner.show();
          this.global.editUser(this.kycParams).subscribe(function (kyc) {
            localStorage.setItem('kycdoc', JSON.stringify(_this4.kycParams));

            if (kyc.Result) {
              _this4.global.loadData();

              _this4.spinner.hide();

              _this4.updateKycMsg = kyc.MSG_USER;
              _this4.kycMessageShow = true;

              _this4.notificationService.showSuccess('Profile KYC has been updated successfully.', 'Success');

              setTimeout(function () {
                _this4.kycMessageShow = false;
              }, 10000);
            }

            console.log(kyc);
          }, function (err) {
            _this4.notificationService.showError(_this4.updateKycMsg, 'Error');
    ...
    KycUploadComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function KycUploadComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function KycUploadComponent_Template_input_change_12_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r428);

            var _r415 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](13);

            return ctx.encodeImageFileAsURL(_r415, "id", $event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_27_listener() {
            return ctx.open_camera("id");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_29_listener() {
            return ctx.showModal("ID proof");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_31_listener() {
            return ctx.updateKYC();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function KycUploadComponent_Template_input_change_41_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r428);

            var _r416 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](42);

            return ctx.encodeImageFileAsURL(_r416, "add", $event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_56_listener() {
            return ctx.open_camera("add");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_58_listener() {
            return ctx.showModal("Address proof");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_60_listener() {
            return ctx.updateKYC();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function KycUploadComponent_Template_input_change_70_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r428);

            var _r417 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](71);

            return ctx.encodeImageFileAsURL(_r417, "oth", $event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_85_listener() {
            return ctx.open_camera("oth");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_87_listener() {
            return ctx.showModal("Other proof");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function KycUploadComponent_Template_button_click_89_listener() {
            return ctx.updateKYC();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](KycUploadComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
        ...
        return [{
          type: _shared_services_notification_service__WEBPACK_IMPORTED_MODULE_1__["NotificationService"]
        }, {
  ...
  /***/
  function srcAppPagesClientCoreDocumentsDocumentsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _documents_core_kyc_upload_kyc_upload_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! ./documents-core/kyc-upload/kyc-upload.component */
    "./src/app/pages/client-core/documents/documents-core/kyc-upload/kyc-upload.component.ts");
    /* harmony import */


    var _documents_core_documents_core_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./documents-core/documents-core.component */
    "./src/app/pages/client-core/documents/documents-core/documents-core.component.ts");
    /* harmony import */
    ...
    DocumentsRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineNgModule"]({
      type: DocumentsRoutingModule
    });
    DocumentsRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](DocumentsRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](DocumentsRoutingModule, [{
  ...
  /***/
  function srcAppPagesClientCoreDocumentsDocumentsModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _documents_core_documents_core_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./documents-core/documents-core.component */
    "./src/app/pages/client-core/documents/documents-core/documents-core.component.ts");
    /* harmony import */


    var _documents_core_kyc_upload_kyc_upload_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./documents-core/kyc-upload/kyc-upload.component */
    "./src/app/pages/client-core/documents/documents-core/kyc-upload/kyc-upload.component.ts");
    /* harmony import */
    ...
    /*! ngx-bootstrap/alert */
    "./node_modules/ngx-bootstrap/__ivy_ngcc__/alert/fesm2015/ngx-bootstrap-alert.js"); // import { ModalModule } from 'ngx-bootstrap/modal';
    ...
    DocumentsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: DocumentsModule
    });
    DocumentsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function DocumentsModule_Factory(t) {
        return new (t || DocumentsModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _documents_routing_module__WEBPACK_IMPORTED_MODULE_3__["DocumentsRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_0__["SharedModule"], ngx_bootstrap_alert__WEBPACK_IMPORTED_MODULE_7__["AlertModule"].forRoot(), ngx_spinner__WEBPACK_IMPORTED_MODULE_6__["NgxSpinnerModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DocumentsModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DocumentsModule, [{
...
//# sourceMappingURL=client-core-documents-documents-module-es5.js.map